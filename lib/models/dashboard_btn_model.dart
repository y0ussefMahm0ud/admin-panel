...
import 'package:admin_panel/screens/edit_upload_product_form.dart';
import 'package:admin_panel/screens/inner_screens/orders/orders_screen.dart';
...
class DashboardButtonsModel {
  ...
  static List<DashboardButtonsModel> dashboardBtnList(BuildContext context) => [
        ...
        DashboardButtonsModel(
          text: "View Orders",
          imagePath: AssetsManager.orderr,
          onPressed: () {
            Navigator.pushNamed(
              context,
